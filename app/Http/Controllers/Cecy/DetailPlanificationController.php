...
use App\Http\Requests\Cecy\DetailsPlanifications\UpdateDetailsPlanificationRequest;
use App\Http\Requests\Cecy\DetailsPlanifications\DeleteDetailsPlanificationRequest;
use App\Http\Requests\Cecy\DetailsPlanifications\StoreDetailsPlanificationRequest;
...
class DetailPlanificationController extends Controller
{
    ...
    function update(UpdateDetailsPlanificationRequest $request, $id)
    {
        ...
        return response()->json([
            'data' => [
                'attributes' => $detailPlanifications,
                'type' => 'detailPlanification'
            ]
        ], 201);
    }

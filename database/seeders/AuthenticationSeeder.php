        ...
        foreach (System::all() as $system) {
            foreach (Institution::all() as $institution) {
                ...
                Role::factory()->create([
                    ...
                    'name' => $system->acronym.' - '.'PROFSIONAL',
                    'system_id' => $system->id,
                    'institution_id' => $institution->id
                ]);

...
class CreateCecyPlanificationsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('pgsql-cecy')->create('planifications', function (Blueprint $table) {
            ...
            $table->foreignId('teacher_id')->constrained('authentication.users')->comment('docente encargado de realizar toda la planificación del cecy, crear su equipo de docentes a impartir el curso, entregar notas, asistencia, etc'); //responsable_id

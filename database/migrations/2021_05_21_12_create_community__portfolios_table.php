...
=======
        $table->foreignId('user_id')->nullable()->constrained('authentication.users')->comment('FK de user,persona que carga el documento ');// persona que carga el documento (estudiante,docente) 

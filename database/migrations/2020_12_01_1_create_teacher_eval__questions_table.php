...
class CreateTeacherEvalQuestionsTable extends Migration
{
    public function up()
    {
        Schema::connection('pgsql-teacher-eval')->create('questions', function (Blueprint $table) {
            $table->id();
            $table->foreignId('evaluation_type_id')->nullable()->comment('Tipo Evaluacion; Pares-Autoevaluacion-Coordinacion-Docente')->constrained('teacher_eval.evaluation_types');

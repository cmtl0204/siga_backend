...
class CreateCommunityProjectParticipantsTable extends Migration
{
    ...
    public function up()
    {
        Schema::connection('pgsql-community')->create('project_participants', function (Blueprint $table) {
            ...
            $table->foreignId('user_id')->nullable()->comment('FK users (Estudiante,docente,adminisrativo), cuando es rector se realiza un join con user_contrato y se extrae la información del contrato del rector')->constrained('app.users');

...
class CreateAuthUsersTable extends Migration
{
    public function up()
    {
        Schema::connection('pgsql-authentication')->create('users', function (Blueprint $table) {
            ...
            $table->foreignId('province_birth_id')->nullable()->constrained('app.locations'); //student
            $table->foreignId('canton_birth_id')->nullable()->constrained('app.locations'); //student
